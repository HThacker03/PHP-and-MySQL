...
--
-- Host: localhost:8889
-- Generation Time: Apr 09, 2025 at 08:00 PM
...
CREATE TABLE `Books` (
  ...
  `Author` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
('0-672-31333-3', 'Jason Adams', 'Java For Dummies', 12.99),
...
--
ALTER TABLE `Book_Reviews`
  ADD CONSTRAINT `book_reviews_ibfk_1` FOREIGN KEY (`ISBN`) REFERENCES `Books` (`ISBN`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
--
ALTER TABLE `Order_Items`
  ADD CONSTRAINT `order_items_ibfk_1` FOREIGN KEY (`OrderID`) REFERENCES `Orders` (`OrderID`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `order_items_ibfk_2` FOREIGN KEY (`ISBN`) REFERENCES `Books` (`ISBN`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
